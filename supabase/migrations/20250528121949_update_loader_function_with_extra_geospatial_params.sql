-- 20250528121949_update_loader_function_with_extra_geospatial_params_COMPLETE.sql
BEGIN;
...
-- 2) Create the new 27-arg version (adds longitude & latitude) WITH COMPLETE IMPLEMENTATION
